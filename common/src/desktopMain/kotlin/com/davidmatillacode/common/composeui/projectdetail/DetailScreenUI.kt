...
import com.davidmatillacode.common.composeui.utils.defaultFontBold
...
@Composable
actual fun DetailScreen(id : Long,
    ...
    Scaffold {
        Column {
            ...
            Text("esto es un texto Detalle ${p?.id_project}", fontFamily = defaultFontBold)
            TextButton(onClick = {
                if(p != null) {
